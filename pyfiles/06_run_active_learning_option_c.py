...
def log_active_learning_config(al_cfg: dict) -> None:
    ...
    logger.info("ucb_kappa              : %s", al_cfg.get("ucb_kappa"))
...
def main() -> None:
    ...
    logger.info("Surrogate: %s", al_cfg.get("surrogate_model", "gradient_boosting"))
    logger.info("Multi-objective strategy: ParEGO-style scalarisation")
