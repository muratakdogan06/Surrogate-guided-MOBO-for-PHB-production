...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(LOGS_DIR / "master_pipeline.log"),
    ],
)
...
IMPROVEMENT_STEPS = [
    ...
    },
    {
        ...
        "description": (
            "One-at-a-time sensitivity analysis for MC-EHVI parameters: "
            "n_mc_samples, diversity_lambda, biomass_min_for_acq, and "
            "ensemble_size. Tornado chart and sensitivity curves generated."
        ),
    },
    {
        "step":   "Step 5 & 6",
        ...
        "description": (
            ...
            "correction comparing AL-EHVI vs all baselines. Power analysis "
...
def generate_final_report(results: list[dict]) -> None:
    ...
    report = {
        ...
        "quality_improvements_summary": {
            ...
            "Step 4":  "OAT sensitivity for n_mc_samples, diversity_lambda, biomass_min_for_acq, ensemble_size",
